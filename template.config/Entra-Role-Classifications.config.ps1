...
$EntraRoleClassifications = @(

    #:-------------------------------------------------------------------------
    # Tier 0 Roles in Microsoft Entra
    #
    # You may move roles to another Tier, based on your own requirements.
    # Custom roles that were created before may also be added here as desired.
    #
    # Settings are inherited from $EntraRoleManagementRulesDefaults.
    ...
    #:-------------------------------------------------------------------------
    # Tier 1 Roles in Microsoft Entra
    #
    # You may move roles to another Tier, based on your own requirements.
    # Custom roles that were created before may also be added here as desired.
    #
    ...
    #:-------------------------------------------------------------------------
    # Tier 2 Roles in Microsoft Entra
    #
    # You may move roles to another Tier, based on your own requirements.
    # Custom roles that were created before may also be added here as desired.
    #
