@{
    ...
    description   = 'Block access for users with active Tier 0 Roles from any country IPv4 and IPv6 address, except from those that are explicitly whitelisted. DO NOT CHANGE MANUALLY!'
