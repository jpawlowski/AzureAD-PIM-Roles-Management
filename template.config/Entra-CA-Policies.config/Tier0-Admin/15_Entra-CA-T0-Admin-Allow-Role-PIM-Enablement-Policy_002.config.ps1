@{
    ...
    description   = "Require '$($EntraCAAuthStrengths[0].scopableRoleEnablement.displayName)' authentication methods before A0C or A1C cloud native admin users may enable a privileged role that is assigned to the '$($EntraCAAuthContexts[0].scopable.displayName)' authentication context in PIM. DO NOT CHANGE MANUALLY!"
    ...
    grantControls = @{
        ...
        AuthenticationStrength = @{
            Id = $EntraCAAuthStrengths[0].scopableRoleEnablement
        }
    }
}
