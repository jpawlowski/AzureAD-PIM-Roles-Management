@(
    @{
        ...
        displayName   = @($EntraCAPolicyTier0DisplayNamePrefix, 'All-Entra-Roles-Except-Tier2-Block-HighRisk-Users') | Join-String -Separator $DisplayNameElementSeparator
        description   = 'Block access for High Risk user accounts with any active Entra ID role, except roles from Tier 2 that could be assigned to any type of user.'
