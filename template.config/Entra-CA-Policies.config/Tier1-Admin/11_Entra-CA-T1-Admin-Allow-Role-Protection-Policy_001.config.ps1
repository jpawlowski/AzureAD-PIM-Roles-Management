@{
    ...
    description   = "Require '$($EntraCAAuthStrengths[1].activeRole.displayName)' authentication methods for A1C cloud native admins and users with active Tier 1 Roles. DO NOT CHANGE MANUALLY!"
    ...
    grantControls = @{
        ...
        AuthenticationStrength = @{
            Id = $EntraCAAuthStrengths[1].activeRole
        }
    }
}
